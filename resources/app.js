...
const ctxhealth =document.getElementById('healthschart').getcontext('2d');
const ctxBreed =document.getElementById('Breedthschart').getcontext('2d');


let cattleArray =[]; // array para almacenar los animales 
let currentEditIndex = null;//indice delanimal que se a editar 
